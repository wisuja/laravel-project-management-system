        ...
        <div class="row">
            <div class="col-3 p-3 bg-light" id="sidebar">
                <ul class="list-unstyled">
                    ...
                    <li class="py-2">
                        <a href="{{ route('projects.show', ['project' => $project, 'type' => 'backlog']) }}"
                            class="btn btn-light w-100 text-left {{ $page == 'backlog' ? 'active' : '' }}">
                            <i class="fas fa-fw fa-tasks mr-1"></i>
                            Backlog
                        </a>
                    </li>
                    <li class="py-2">
                        <a href="{{ route('projects.show', ['project' => $project, 'type' => 'boards']) }}"
                            class="btn btn-light w-100 text-left {{ $page == 'boards' ? 'active' : '' }}">
                            <i class="fas fa-fw fa-clipboard mr-1"></i>
                            Board
                        </a>
                    </li>
                    <li class="py-2">
                        <a href="{{ route('projects.show', ['project' => $project, 'type' => 'setting']) }}"
                            class="btn btn-light w-100 text-left {{ $page == 'setting' ? 'active' : '' }}">
